import { c as createComponent, r as renderTemplate, m as maybeRenderHead, d as addAttribute, a as renderComponent, b as createAstro } from './astro/server_SkBeWfGi.mjs';
...
}, "C:/Users/HP/Desktop/dev-books/src/components/AmazonLogo.astro", undefined);
...
const $$BuyButton = createComponent(($$result, $$props, $$slots) => {
  ...
  const BOLIVIA = "BO";
  const country = Astro2.request.headers.get("X-Vercel-IP-Country") ?? "BO";
  const storeCountry = country === BOLIVIA ? "bolivia" : "usa";
  const countryName = country === BOLIVIA ? "Bolivia" : "Estados Unidos";
...
}, "C:/Users/HP/Desktop/dev-books/src/components/BuyButton.astro", undefined);

const $$file = "C:/Users/HP/Desktop/dev-books/src/components/BuyButton.astro";
const $$url = undefined;
